...
Billing needs to be enabled for your project to use Google Cloud Platform features. To enable billing refer to `Google cloud documentation <https://cloud.google.com/billing/docs/how-to/modify-project>`__
...
Open the example in :guilabel:`File -> Examples -> AmebaMQTTClient -> Google_Cloud_IoT`
