...
- Auto. Select :guilabel:`Tools -> Auto Upload Mode -> Enable`

.. note:: Only boards with auto upload circuit built-in can use the Auto Upload Mode, otherwise it will back to normal upload mode and wait for 5 seconds.
