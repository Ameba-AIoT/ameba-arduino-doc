...
Open the sample code in :guilabel:`File -> Examples -> AmebaFlashMemory -> ReadWriteStream` Compile and upload to Ameba, then press the reset button multiple times. Open the Serial Monitor, review the result.
