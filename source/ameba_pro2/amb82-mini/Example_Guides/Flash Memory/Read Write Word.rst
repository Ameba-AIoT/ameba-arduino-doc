...
Open the example, :guilabel:`File -> Examples -> AmebaFlashMemory -> ReadWriteWord` Compile and upload to Ameba, then press the reset button multiple times. Open the Serial Monitor, review the result.
