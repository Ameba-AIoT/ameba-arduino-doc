...
Open the example :guilabel:`File -> Examples -> AmebaGTimer -> TimerOneshot` Compile and upload to Ameba, and press reset. Then you can see the 4 timer log printed to the serial monitor in series.
