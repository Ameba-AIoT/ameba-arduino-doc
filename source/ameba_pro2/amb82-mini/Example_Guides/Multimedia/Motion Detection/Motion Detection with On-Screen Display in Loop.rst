Motion Detection with On-Screen Display in Loop
===============================================
...
Open one of the Motion Detection examples in :guilabel:`File -> Example -> AmebaMultimedia -> MotionDetection -> LoopPostProcessing`
