...
Open example in :guilabel:`File -> Examples -> AmebaPowerMode -> RetentionStandbyMode`
...
.. note ::
   SLP_RTC is not supported with retention
   SLP_GTIMER is automatically added when retention is enabled
