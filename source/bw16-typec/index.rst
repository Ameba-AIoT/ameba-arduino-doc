...
.. table::
   ...
   |    - TBD                                                               | - Other Features                                         |
   | - Regional                                                             |    - 2 UART interfaces                                   |
   |    - `Taiwan ICShop <link01_>`_                                        |    - 1 I2C Interface                                     |
   |    - `Taiwan ICShop (Module only) <link02_>`_                          |    - 1 ADC interfaces                                    |
   |                                                                        |    - 1 SPI interfaces                                    |
   |                                                                        |    - 5 PWM interfaces                                    |
   |                                                                        |    - Max 13 GPIO                                         |
   |                                                                        |    - 1 RGB LED                                           |
...
.. |image01| image:: ../_static/ameba_board_photos/BW16-typec.png
   :width:  150px
